...
# COMPILE GROMACS 2021.5 PLUMED 2.8.0
...
PLUMED_BINARY=${USR_LOCAL_DIR}/plumed_${PLUMED_VERSION}/bin/plumed

GMX_VERSION="2021.5"

GMX_DIR=${INSTALL_DIR}/gromacs_${GMX_VERSION}_plumed_${PLUMED_VERSION}


echo -e "=================================================== "

echo -e "=== CODE UNTESTED FOR MULTIPLE VERSIONS OF PLUMED "

echo -e "=== PLUMED INSTALLATION WILL PROCEED WITH MPI "
...
### CHECK IF PLUMED IS ACTIVE ; STOP OTHERWISE

CHECK_PLUMEDINSTALLATION=$(${PLUMED_BINARY} --is-installed)

if [[ "${CHECK_PLUMEDINSTALLATION}" != "" ]]; then

echo -e "=================================================== "

echo -e "=== POTENTIAL ERRORS WITH PLUMED "

echo -e "=== PLEASE CHECK PLUMED INSTALLATION AND RETRY "
...
${PLUMED_BINARY} patch -p -e gromacs-${GMX_VERSION}
...
echo -e "=== ADDING GROMACS ${GMX_VERSION} PLUMED TO PATH... "

echo -e "================================================== "

echo -e "\n### ADD GROMACS ${GMX_VERSION} PLUMED ${PLUMED_VERSION} TO PATH" >> ~/.bashrc
